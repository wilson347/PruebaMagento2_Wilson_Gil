...
QUERY;
     ...
     * @magentoApiDataFixture Magento/Pricing/_files/category.php
     * @magentoApiDataFixture Magento/Pricing/_files/products_with_layered_navigation_attribute.php
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/category.php
     * @magentoApiDataFixture Magento/Pricing/_files/configurable_products_with_custom_attribute_layered_navigation.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/products_with_layered_navigation_custom_attribute.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/products_with_layered_navigation_with_multiselect_attribute.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/categories.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/category.php
     * @magentoApiDataFixture Magento/Pricing/_files/multiple_products.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
    ...
    /**
     * @magentoApiDataFixture Magento/Pricing/_files/category_with_three_products.php
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/category.php
     * @magentoApiDataFixture Magento/Pricing/_files/multiple_mixed_products_2.php
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/products_for_relevance_sorting.php
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/product_in_multiple_categories.php
     * @return void
     */
...
QUERY;
     ...
     *
     * @magentoApiDataFixture Magento/Pricing/_files/category.php
     * @magentoApiDataFixture Magento/Pricing/_files/multiple_products_with_different_sku_and_name.php
     */
...
QUERY;
    ...
    /**
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     * @magentoApiDataFixture Magento/Pricing/_files/multiple_products_with_few_out_of_stock.php
     */
