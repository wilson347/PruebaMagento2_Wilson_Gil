...
class AddSimpleProductToCartTest extends GraphQlAbstract
{
    ...
    /**
     * @magentoApiDataFixture Magento/GraphQl/Pricing/_files/simple_product.php
    ...
    /**
     * @magentoApiDataFixture Magento/Pricing/_files/product_with_image_no_options.php
     * @magentoApiDataFixture Magento/GraphQl/Quote/_files/guest/create_empty_cart.php
     */
...
QUERY;
     ...
     * @magentoApiDataFixture Magento/GraphQl/Pricing/_files/set_simple_product_out_of_stock.php
     * @return void
