...
class CategoryLinkManagementTest extends TestCase
{
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_with_category.php
     *
     * @magentoDbIsolation disabled
     *
     * @return void
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/second_product_simple.php
     * @magentoDataFixture Magento/Pricing/_files/categories_no_products.php
     *
     * @magentoDbIsolation disabled
     *
     * @return void
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_simple_with_category_which_has_parent_category.php
     *
     * @magentoDbIsolation disabled
     *
     * @return void
