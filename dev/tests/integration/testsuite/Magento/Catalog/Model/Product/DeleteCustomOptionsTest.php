...
class DeleteCustomOptionsTest extends TestCase
{
     ...
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\Area::getDataForCreateOptions()
     *
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\File::getDataForCreateOptions()
     *
     * @param array $optionData
     * @return void
     */
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\Date::getDataForCreateOptions()
     *
     * @param array $optionData
     * @return void
     */
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\DateTime::getDataForCreateOptions()
     *
     * @param array $optionData
     * @return void
     */
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\Time::getDataForCreateOptions()
     *
     * @param array $optionData
     * @return void
     */
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\DropDown::getDataForCreateOptions()
     *
     * @param array $optionData
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\RadioButtons::getDataForCreateOptions()
     *
     * @param array $optionData
     * @param array $optionValueData
     * @return void
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\Checkbox::getDataForCreateOptions()
     *
     * @param array $optionData
     * @param array $optionValueData
     * @return void
     ...
     * @magentoDataFixture Magento/Pricing/_files/product_without_options.php
     *
     * @dataProvider \Magento\TestFramework\Pricing\Model\Product\Option\DataProvider\Type\MultipleSelect::getDataForCreateOptions()
     *
     * @param array $optionData
     * @param array $optionValueData
     * @return void
