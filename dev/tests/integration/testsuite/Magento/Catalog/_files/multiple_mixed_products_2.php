...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/configurable_attribute.php');
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/multiple_products.php');
