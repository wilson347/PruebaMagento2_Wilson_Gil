...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/attribute_set_based_on_default_set.php');
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/categories.php');
