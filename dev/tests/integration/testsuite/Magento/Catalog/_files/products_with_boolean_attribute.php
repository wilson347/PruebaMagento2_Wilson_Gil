...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/products_for_search.php');
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_boolean_attribute.php');
