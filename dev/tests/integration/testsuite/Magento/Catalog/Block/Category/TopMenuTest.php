...
class TopMenuTest extends TestCase
{
     ...
     * @magentoDataFixture Magento/Pricing/_files/categories_no_products_with_two_tree.php
     * @magentoAppIsolation enabled
     ...
     * @magentoDataFixture Magento/Pricing/_files/category.php
     * @magentoDataFixture Magento/Pricing/_files/category_in_second_root_category.php
