...
class ProductInCategoriesViewTest extends TestCase
{
    ...
    /**
     * @magentoDataFixture Magento/Pricing/_files/category_with_two_products.php
     ...
     * @magentoDataFixture Magento/Pricing/_files/out_of_stock_product_with_category.php
     * @return void
     */
    ...
    /**
     * @magentoDataFixture Magento/Pricing/_files/category_tree.php
    ...
    /**
     * @magentoDataFixture Magento/Pricing/_files/products_with_websites_and_stores.php
