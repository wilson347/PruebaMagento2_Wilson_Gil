...
class RenderOptionsTest extends AbstractRenderCustomOptionsTest
{
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_without_options_with_stock_data.php
     * @dataProvider \Magento\TestFramework\Pricing\Block\Product\View\Options\TextGroupDataProvider::getData
     *
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_without_options_with_stock_data.php
     * @dataProvider \Magento\TestFramework\Pricing\Block\Product\View\Options\FileGroupDataProvider::getData
     *
     * @param array $optionData
     * @param array $checkArray
     * @return void
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_without_options_with_stock_data.php
     * @dataProvider \Magento\TestFramework\Pricing\Block\Product\View\Options\SelectGroupDataProvider::getData
     *
     * @param array $optionData
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_without_options_with_stock_data.php
     * @dataProvider \Magento\TestFramework\Pricing\Block\Product\View\Options\DateGroupDataProvider::getData
     *
     * @param array $optionData
     * @param array $checkArray
     * @return void
