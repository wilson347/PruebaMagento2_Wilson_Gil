...
class ViewTest extends AbstractController
{
     ...
     * @magentoDataFixture Magento/Pricing/controllers/_files/products.php
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_simple_with_country_of_manufacture.php
     * @magentoDataFixture Magento/Pricing/_files/attribute_set_based_on_default_without_country_of_manufacture.php
     * @return void
     */
    ...
    /**
     * @magentoDataFixture Magento/Pricing/_files/simple_products_not_visible_individually.php
     */
    ...
    /**
     * @magentoDataFixture Magento/Pricing/_files/product_two_websites.php
     * @magentoDbIsolation disabled
     * @return void
     */
