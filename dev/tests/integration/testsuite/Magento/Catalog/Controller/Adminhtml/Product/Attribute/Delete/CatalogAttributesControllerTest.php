...
class CatalogAttributesControllerTest extends AbstractDeleteAttributeControllerTest
{
     ...
     *
     * @magentoDataFixture Magento/Pricing/_files/product_image_attribute.php
     *
     * @return void
     */
     ...
     * after dispatch delete product attribute action.
     *
     * @magentoDataFixture Magento/Pricing/_files/product_decimal_attribute.php
     *
     * @return void
     */
     ...
     * after dispatch delete product attribute action.
     *
     * @magentoDataFixture Magento/Pricing/_files/product_date_attribute.php
     *
     * @return void
     */
     ...
     * after dispatch delete product attribute action.
     *
     * @magentoDataFixture Magento/Pricing/_files/product_dropdown_attribute.php
     *
     * @return void
     */
     ...
     * after dispatch delete product attribute action.
     *
     * @magentoDataFixture Magento/Pricing/_files/multiselect_attribute.php
     *
     * @return void
     */
     ...
     * after dispatch delete product attribute action.
     *
     * @magentoDataFixture Magento/Pricing/_files/product_varchar_attribute.php
     *
     * @return void
     */
