...
class ProductListTest extends TestCase
{
     ...
     *
     * @magentoDbIsolation disabled
     * @magentoDataFixture Magento/Pricing/_files/products_with_dropdown_attribute.php
     */
     ...
     *
     * @magentoDbIsolation disabled
     * @magentoDataFixture Magento/Pricing/_files/product_simple_xss.php
     * @magentoDataFixture Magento/Pricing/_files/product_virtual.php
     ...
     *
     * @magentoDbIsolation disabled
     * @magentoDataFixture Magento/Pricing/_files/product_simple_with_date_attribute.php
     * @return void
     * @throws \Magento\Framework\Exception\LocalizedException
     */
     ...
     *
     * @magentoDbIsolation disabled
     * @magentoDataFixture Magento/Pricing/_files/product_in_nested_anchor_categories.php
     */
     ...
     *
     * @magentoDbIsolation disabled
     * @magentoDataFixture Magento/Pricing/_files/category_with_different_price_products.php
