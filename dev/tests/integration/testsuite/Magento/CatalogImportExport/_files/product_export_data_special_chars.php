...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/catalog_category_with_slash.php');
...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/products_with_multiselect_attribute.php');
/** Create dummy text attribute */
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_text_attribute.php');
