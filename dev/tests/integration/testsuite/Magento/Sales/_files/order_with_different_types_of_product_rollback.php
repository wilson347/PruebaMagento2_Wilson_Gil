...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_simple_without_custom_options_rollback.php');
Resolver::getInstance()->requireDataFixture('Magento/ConfigurableProduct/_files/product_configurable_rollback.php');
Resolver::getInstance()->requireDataFixture('Magento/GraphQl/Pricing/_files/virtual_product_rollback.php');
