...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_simple_without_custom_options.php');
...
Resolver::getInstance()->requireDataFixture('Magento/GraphQl/Pricing/_files/virtual_product.php');
