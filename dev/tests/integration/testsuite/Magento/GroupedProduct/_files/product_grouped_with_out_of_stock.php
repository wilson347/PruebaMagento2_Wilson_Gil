...
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_associated.php');
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_virtual_in_stock.php');
Resolver::getInstance()->requireDataFixture('Magento/Pricing/_files/product_virtual_out_of_stock.php');
